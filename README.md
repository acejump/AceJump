...
If you are using [IdeaVim](https://plugins.jetbrains.com/plugin/164), you may wish to remap a normal-mode key to activate AceJump. For example, paste the following line into your terminal to activate various modes in AceJump with a single keystroke. 
